...
class QuizView extends Quiz
{
	...
	function dispQuizIndex() 
	{
		...
		foreach($questions_list as $question) 
		{
			...
			$questionHTML = $oQuizModel->getQuestionHTML($question, $question_log, $quiz_info, $quiz_log);
	...
	function dispQuizQuestion() 
	{
		...
		$questionHTML = $oQuizModel->getQuestionHTML($question, $question_log, $quiz_info);
...
/* End of file quiz.view.php */
/* Location: quiz.view.php */
